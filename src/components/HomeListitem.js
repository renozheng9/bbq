    ...
    return(
      <View style={styles.item}>
        ...
        >
          <View style={{flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0, 0, 0, 0.5)'}}>
            <View style={{width : width*0.9, borderRadius: 5, alignItems: 'flex-start', backgroundColor: '#fff', padding: 10}}>
              <View style={{flex: 1, flexDrection: 'row', alignItems: 'center'}}>
                <Text style={{fontSize: FontSize(18), color: '#666666', fontWeight: 'bold'}}>举报</Text>
              </View>
              ...
              <View style={{alignItems: 'flex-end'}}>
                <Text style={{fontSize: FontSize(14), color: '#888888'}}>{this.state.reason.length}/50</Text>
              </View>
              <View style={{flex: 1, flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'center'}}>
                <TouchableWithoutFeedback onPress={() => {this.setState({modalVisible: false})}}>
                  <Text style={{fontSize: FontSize(16), color: '#53BFA2', marginRight: 15}}>取消</Text>
                </TouchableWithoutFeedback>
                <TouchableWithoutFeedback onPress={this.submit}>
                  <Text style={{fontSize: FontSize(16), color: '#53BFA2'}}>提交</Text>
                </TouchableWithoutFeedback>
              </View>
            </View>
          </View>
        ...
        <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
          <TouchableWithoutFeedback onPress={() => {Actions.push('themeDetail', {'themeID': this.props.item.theme_id, 'themeName': this.props.item.theme_name, 'themeIntroduction': this.props.item.theme_introduction})}}>
            <View style={{flexDirection: 'row'}}>
              ...
              <View>
                <Text style={{fontSize: FontSize(12), color: '#666666'}}>{this.state.item.theme_name}</Text>
                <Text style={{fontSize: FontSize(10), color: '#888888'}}>{this.state.item.create_time}</Text>
              </View>
            </View>
          </TouchableWithoutFeedback>
          <View style={{justifyContent: 'center'}}>
            ...
            {/* <Picker
              ...
              onValueChange={(itemValue, itemIndex) => this.choose(itemValue)}>
        ...
        <View style={{marginTop: 10, flexDirection: 'row', justifyContent: 'space-between'}}>
          <TouchableWithoutFeedback onPress={() => {Actions.push('zone', {'userID': this.props.item.user_id, 'avatar': this.props.item.user_avatar, 'nickname': this.props.item.user_nickname, 'signature': this.props.item.user_signature})}}>
          <View style={{flexDirection: 'row', alignItems: 'center'}}>
            <Thumbnail style={{width: width*0.06, height: width*0.06, marginRight: width*0.01}} source={require("../images/person.png")} />
            <Text style={{fontSize: FontSize(12), color: '#666666'}}>{this.state.item.user_nickname}</Text>
          </View>
          </TouchableWithoutFeedback>
          <View style={styles.operations}>
            <TouchableWithoutFeedback>
              <View style={styles.operation}>
                <Icon name="md-share" style={{fontSize: FontSize(12), color: '#666666', marginRight: 2}} />
                <Text style={{fontSize: FontSize(11), color: '#666666'}}>转发</Text>
              </View>
            </TouchableWithoutFeedback>
            <TouchableWithoutFeedback>
              <View style={styles.operation}>
                <Icon name="md-text" style={{fontSize: FontSize(12), color: '#666666', marginRight: 2}} />
                <Text style={{fontSize: FontSize(11), color: '#666666'}}>评论</Text>
              </View>
            </TouchableWithoutFeedback>
            <TouchableWithoutFeedback onPress={() => this.upvote()}>
              <View style={styles.operation}>
                <Icon name="md-thumbs-up" style={{fontSize: FontSize(12), color: (this.state.item.isUpvote == 0) ? '#666666' : '#53BFA2', marginRight: 2}} />
                <Text style={{fontSize: FontSize(11), color: '#666666'}}>{this.state.item.likes}</Text>
              </View>
            </TouchableWithoutFeedback>
          </View>
        </View>
